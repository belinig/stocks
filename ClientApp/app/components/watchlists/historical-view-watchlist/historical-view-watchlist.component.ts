...
@Component({
    selector: 'historical-view-watchlist',
    templateUrl: './historical-view-watchlist.component.html',
    styleUrls: ['./historical-view-watchlist.component.css'],
    providers: [MdSortHeaderIntl]
})
export class HistoricalViewWatchlistComponent extends ViewWatchlistComponent  {
    ...
    constructor(wService: WatchlistDataService,
        router: Router,
        route: ActivatedRoute,
        sortHeaderIntl: MdSortHeaderIntl) {
        super(wService, router, route, sortHeaderIntl);
    }
    ...
    public changeWatchlist(selectedWatchlist: any) {
        ...
        let qdate: Date = new Date(this.quotedate);
        this.getWatchlistHistorical(this.selectedWatchlistName, qdate);
    }
    ...
    public getWatchlistHistorical(watchlistName: string, quotedate: Date) {
        console.log("ViewWatchlistComponent - watchlistName")
        this.stopSpinner = false;
        this.wService.getWatchlistHistoricalData(watchlistName, quotedate).subscribe(result => {
